...
/** @param {import('./main.js').MuJoCoDemo} parentContext */
...
export async function loadSceneFromURL(mujoco, filename, parent) {
    ...
    // Avoid rendering uninitialized instances for scenes that do not call drawTendonsAndFlex().
